...
typedef int(* eq_func)(char a, char b);

static inline int ls_case_insen_eq(char a, char b)
{
	return tolower(a) == tolower(b);
}

static inline int ls_case_sen_eq(char a, char b)
{
	return a == b;
}

unsigned int levenshtein(const char *word1, const char *word2, int case_sen) {
